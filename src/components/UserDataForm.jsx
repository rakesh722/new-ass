...
const UserDataForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      ...
      <Button type="submit" variant="contained" sx={{ marginTop: '20px' }}   class="shadow bg-purple-500 hover:bg-purple-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" >Submit</Button>
